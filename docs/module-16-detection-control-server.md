...
```json
{"type":"detection","source_id":"video.mp4","frame_index":120,"pts_ms":4000,"detection_count":1,"detections":[{"track_id":3,"class_id":0,"class_name":"face","confidence":0.92,"box":{"x":100,"y":80,"width":60,"height":40}}]}
```
